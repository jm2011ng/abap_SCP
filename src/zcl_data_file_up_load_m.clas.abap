CLASS zcl_data_file_up_load_m DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_data_file_up_load_m IMPLEMENTATION.
...
*as well as the raw file data.
        ...
        IF sy-subrc = 0.
          ...
          ENDIF.
        ENDIF.
        DELETE content FROM 1 TO 4. " Get rid of the
*first 4 lines
...
*put it all back together again humpdy dumpdy....
        ...
        ENDLOOP.
* Unpack input field values such as tablename,
*dataoption, etc.
...
* Check table name is valid.
        IF
* xco_cp_abap_repository=>object->tabl-
*>database_table->for(
* iv_name = CONV #(
*tablename ) )->exists( ) = abap_false
* OR
...
* Load the data to the table via dynamic internal table
        ...
        CHANGING data =
        <table_structure> ).
        IF dataoption = `1`. "if replace, delete the
